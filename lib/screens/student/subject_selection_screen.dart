    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: _selectedInstitution != null
            ? IconButton(
                icon: const Icon(Icons.arrow_back), onPressed: _resetSelection)
            : null,
      ),
      body: Container(
            ...
            return Padding(
              ...
              child: GlassCard(
                child: ListTile(
                  ...
                  trailing:
                      const Icon(Icons.chevron_right, color: Color(0xFF00D1FF)),
          ...
          child: StreamBuilder<List<Subject>>(
            ...
            builder: (context, snapshot) {
              ...
              final subjects = snapshot.data!
                  .where((s) => s.institutionId == _selectedInstitution!.id)
                  .toList();

              if (subjects.isEmpty) {
                return const Center(
                    child: Text('Nenhuma disciplina deste professor.',
                        style: TextStyle(color: Colors.white54)));
              }
                    ...
                    child: GlassCard(
                      child: ListTile(
                        ...
                        trailing: ElevatedButton(
                          onPressed: () =>
                              _confirmEnrollment(context, service, subject),
  ...
  void _confirmEnrollment(
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const AiTranslatedText('Confirmar Inscrição',
            ...
            onPressed: () async {
              ...
              if (context.mounted) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                      content:
                          Text('Pedido de inscrição enviado com sucesso!')),
                );
              }
            },
