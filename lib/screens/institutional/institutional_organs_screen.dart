...
class InstitutionalOrgansScreen extends StatelessWidget {
  ...
  const InstitutionalOrgansScreen({super.key, required this.institution});
  ...
  void _showAddOrganDialog(BuildContext context, String institutionId) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        title: const AiTranslatedText('Novo Órgão',
            ...
            onPressed: () async {
              if (nameController.text.isNotEmpty) {
                ...
                await service.createOrgan(InstitutionOrgan(
                  ...
                  presidentEmail: presidentController.text.isEmpty
                      ? null
                      : presidentController.text,
                  vicePresidentEmail: vicePresidentController.text.isEmpty
                      ? null
                      : vicePresidentController.text,
