class InstitutionModel {
  ...
  final List<String> authorizedProfessorIds; // UIDs of professors approved for this institution
  ...
  final int aiCredits;
  final Map<String, dynamic>? whiteLabelSettings; // logoUrl, customColors, domain
  ...
  factory InstitutionModel.fromMap(Map<String, dynamic> map) {
    return InstitutionModel(
      ...
      authorizedProfessorIds: List<String>.from(map['authorizedProfessorIds'] ?? []),
      ...
      whiteLabelSettings: map['whiteLabelSettings'] != null ? Map<String, dynamic>.from(map['whiteLabelSettings']) : null,
