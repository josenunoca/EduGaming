...
class MarketingExportHelper {
  static Future<Uint8List> generateMarketingPdf({
    required MarketingEvent activity,
  ...
  static Future<void> downloadPdf(MarketingEvent activity, String platform, String content) async {
  ...
  static Future<void> downloadZip(MarketingEvent activity, String platform, String content) async {
    final pdfBytes = await generateMarketingPdf(
      activity: activity,
      platform: platform,
      generatedContent: content,
